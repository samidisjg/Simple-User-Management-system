...
<head>
    ...
    <link rel="stylesheet" href="s_css/s_Registerstyle.css">
...
<div class = "card1">
        <div class="row">
            <div class="column1">
                <form method="POST" action="s_new1update.php" class="form">
                    ...
                    <div class="input1">
                        ...
                        <input type="text" name="userName" required value="<?php echo $_SESSION['userName']; ?>"><br>
                    </div>
                    ...
                    <div class="input1">
                        ...
                        <input type="password" name="password" id="password" value="<?php echo $pwd; ?>" required><br>
                    </div>

                    <div class="input1">
                    <label for="cType"><b>Citizen Type:</b></label><br>
                    <input type="text" name="citizens" id="citizens" value="<?php echo $type; ?>" required><br>
                    </div>

                    <div class="input1">
                    <label for="gender"><b>Gender :</b></label><br>
                    <input type="text" name="gender" id="gender" value="<?php echo $gender; ?>" required><br>
                    </div>

                    <div class="input1">
                        <label for ="NICpass"><b>NIC/Passport No:</b></label><br>
                        <input type="text" name="nic" id="nic" value="<?php echo $nic; ?>" required><br>
                    </div>
                    ...
                    <div class="input1 ">
                    <button type = "submit" name="btn2" size="50" onclick="return confirmUpdate();"><a href="s_viewprofile.php">Update Details</a></button>
                    </div>
                </form>
                <div class="img1">
                    <img src = "s_images/image94.jpg" width="550px" height="900px">
                </div>
            </div>
        </div>
    </div>
